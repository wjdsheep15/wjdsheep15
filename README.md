...
- React, Jsp, Java언어를 활용한 서비스 개발을 중심으로 실서비스 운영 경험과 성능 최적화에 관심이 많습니다.  
- 책임감 있게 문제를 해결하며, 함께 일하고 싶은 개발자가 되기 위해 노력하고 있습니다.
...
### 🌠 Star-Breaker-Raid  
**로스트아크 레이드 초보자를 위한 스케줄 조율 및 가이드 매칭 서비스**  
**Stack:** Next.js, PostgreSQL, Vercel, Auth.js, Zustand

- 구글 검색엔진 등록 및 SEO 최적화  
- Vercel Speed Insights 및 Observability를 활용한 성능 개선  
...
### 🛡️ CSPM MVP (교보DTS 기업협업)  
**클라우드 보안 취약점 진단 시스템**  
**Stack:** Spring Boot, QueryDSL, AWS SDK, MariaDB

- 테크 리더로서 핵심 로직 설계 및 기획자와의 소통 주도  
...
📚 공부한 내용을 기록한 Velog 블로그도 확인해주세요!  
[![Velog](https://img.shields.io/badge/Velog-20C997?style=for-the-badge&logo=Velog&logoColor=white)](https://velog.io/@wjd15sheep/posts)
